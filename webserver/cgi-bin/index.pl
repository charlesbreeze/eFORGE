...
sub print_credits_box {
    print Template::content_box("Credits",
        ...
        Iotchkova, V., Frontini, M., Downes, K., Ouwehand, W.H., Laperle, J., Jacques, P.-E., Bourque, G., Bergmann, A.K., 
...
sub print_about_page {
    ...
    "Spurrell, C.H., Dickel, D.E., Visel, A., 2016. The Ties That Bind: Mapping the Dynamic Enhancer-Promoter Interactome. <i> Cell</i> 167, 1163-1166.",
    "Mendelson, M.M., Marioni, R.E., Joehanes, R., Liu, C., Hedman, Asa K., Aslibekyan, S., Demerath, E.W., Guan, W., Zhi, D., Yao, C., et al. (2017). Association of Body Mass Index with DNA Methylation and Gene Expression in Blood Cells and Relations to Cardiometabolic Disease: A Mendelian Randomization Approach. <i> PLoS Med.</i> 14, e1002215.",
    "Bujold, D., de Lima Morais, D.A., Gauthier, C., Cote, C., Caron, M., Kwan, T., Chen, K.C., Laperle, J., Markovits, A.N., Pastinen, T., et al. (2016). The International Human Epigenome Consortium Data Portal. <i> Cell Syst.</i> 3, 496-499.",
    "Johnson, K.C., Houseman, E.A., King, J.E., and Christensen, B.C. (2017). DNA methylation differences at regulatory elements are associated with the cancer risk factor age in normal breast tissue. <i> bioRxiv</i> 101287.",
    "Li, Y., Xu, Q., Lv, N., Wang, L., Zhao, H., Wang, X., Guo, J., Chen, C., Li, Y., and Yu, L. (2017). Clinical implications of genome-wide DNA methylation studies in acute myeloid leukemia. <i> J. Hematol. Oncol.</i> 10, 41.",
    "Ligthart, S., Marzi, C., Aslibekyan, S., Mendelson, M.M., Conneely, K.N., Tanaka, T., Colicino, E., Waite, L.L., Joehanes, R., Guan, W., et al. (2016). DNA methylation signatures of chronic low-grade inflammation are associated with complex diseases. <i> Genome Biol.</i> 17, 255.",
    "Rodger, E.J., and Chatterjee, A. (2017). The epigenomic basis of common diseases. <i> Clin. Epigenetics</i> 9, 5.",
